...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x49, 0x0a, 0x08, 0x47,
	0x72, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x3d, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65,
	...
	0x52, 0x65, 0x70, 0x6c, 0x61, 0x79, 0x42, 0x12, 0x5a, 0x10, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f,
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.Greeting.SayHello:input_type -> helloworld.HelloRequest
	1, // 1: helloworld.Greeting.SayHello:output_type -> helloworld.HelloReplay
...
func (c *greetingClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReplay, error) {
	out := new(HelloReplay)
...
func (*UnimplementedGreetingServer) SayHello(context.Context, *HelloRequest) (*HelloReplay, error) {
